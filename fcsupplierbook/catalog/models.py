...
class Company(models.Model):
    ...
    short_name = models.CharField(max_length=10, help_text="Shortened name of the company.")
    ...
    number_of_employees = models.PositiveIntegerField(null=True, blank=True, help_text="Approximate number of employees.")
...
class Story(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.PROTECT, help_text="Choose a company that the entry is connected to.")


class Product(models.Model):
    product_type = models.CharField(max_length=3, choices=PRODUCT_TYPE)
    model_name = models.CharField(max_length=32, help_text="Company's name for the product.")
    company = models.ForeignKey(Company, on_delete=models.PROTECT, help_text="Company owning the product.")
